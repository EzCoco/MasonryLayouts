...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "6f5336b0-a34d-4063-a8fd-d529574b4a28",
...
const _lazy_6Xjzgo = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_6Xjzgo, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_6Xjzgo, lazy: true, middleware: false, method: undefined }
];
