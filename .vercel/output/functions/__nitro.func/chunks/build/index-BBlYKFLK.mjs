import { mergeProps, defineComponent, withAsyncContext, ref, computed, toValue, reactive, watch, getCurrentInstance, onServerPrefetch, shallowRef, toRef, unref, useSSRContext, createElementBlock, provide, openBlock, normalizeClass, renderSlot, createVNode, Transition, withCtx, withDirectives, createElementVNode, normalizeStyle, createTextVNode, toDisplayString, vShow, shallowReactive, createBlock, createCommentVNode, resolveDynamicComponent, Fragment, withModifiers, warn, nextTick, inject, isRef, isVNode, render } from 'vue';
...
import { _ as _export_sfc$1, f as fetchDefaults, a as useNuxtApp, d as asyncDataDefaults, e as createError, i as isNumber, j as isUndefined, g as isStringNumber, k as useZIndex, l as defaultInitialZIndex, z as zIndexContextKey, m as isElement, o as isBoolean } from './server.mjs';
import { p as publicAssetsURL } from '../routes/renderer.mjs';
import { v as hash } from '../_/nitro.mjs';
import { isPlainObject, isString, isObject, hasOwn, isFunction } from '@vue/shared';
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-1f830034></div>`);
}
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc$1(_sfc_main$7, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-1f830034"]]);
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    console.log("src", __props.src);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<video${ssrRenderAttrs(mergeProps({
        "vjs-big-play-centered": "",
        controls: ""
      }, _attrs))}><source${ssrRenderAttr("src", __props.src)} type="video/webm"></video>`);
    };
  }
});
...
const _imports_0 = publicAssetsURL("/like.svg");
...
var Badge = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__file", "badge.vue"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/data", "$PbiCBMM6ag")), __temp = await __temp, __restore(), __temp);
    const dataList = ref([]);
    ref(true);
    ref(null);
    ref(false);
    ...
    ref(false);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Player = _sfc_main$6;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))} data-v-bfeaaab8><div class="${ssrRenderClass([{ active: isRefreshing.value }, "refresh-tip"])}" data-v-bfeaaab8>`);
      if (isRefreshing.value) {
        _push(`<span data-v-bfeaaab8>\u52A0\u8F7D\u4E2D...</span>`);
      } else {
        _push(`<span data-v-bfeaaab8>\u2193 \u4E0B\u62C9\u5237\u65B0</span>`);
      }
      _push(`</div><div class="content" data-v-bfeaaab8><!--[-->`);
      ssrRenderList(dataList.value, (item, index2) => {
        _push(`<div class="card" style="${ssrRenderStyle({
          left: item == null ? void 0 : item.left,
          top: item == null ? void 0 : item.top,
          width: `${item.imgWidth}px`
        })}" data-v-bfeaaab8>`);
        if ((item == null ? void 0 : item.type) == "video") {
          _push(`<!--[--><div class="title-container" data-v-bfeaaab8><div data-v-bfeaaab8><div class="desc" data-v-bfeaaab8>${ssrInterpolate(item.title + item.username)}</div><div class="like" data-v-bfeaaab8><img${ssrRenderAttr("src", _imports_0)} data-v-bfeaaab8> ${ssrInterpolate(item.likes)}</div></div></div>`);
          ...
          _push(`<!--[--><div class="title-container" data-v-bfeaaab8><div class="title" data-v-bfeaaab8>${ssrInterpolate(item.title)}</div><div data-v-bfeaaab8><div class="desc" data-v-bfeaaab8>${ssrInterpolate(item.username)}</div><div class="like" data-v-bfeaaab8><img${ssrRenderAttr("src", _imports_0)} data-v-bfeaaab8> ${ssrInterpolate(item.likes)}</div></div></div><img${ssrRenderAttr("src", `/png/${item.img}`)} style="${ssrRenderStyle({ "width": "100%" })}" data-v-bfeaaab8><!--]-->`);
        }
        _push(`</div>`);
      });
      _push(`<!--]--></div></div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc$1(_sfc_main$2, [["__scopeId", "data-v-bfeaaab8"]]);
const _sfc_main$1 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))} data-v-92e24446></div>`);
}
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-92e24446"]]);
const _sfc_main = {};
...
//# sourceMappingURL=index-BBlYKFLK.mjs.map
