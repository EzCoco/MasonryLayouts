import { getCurrentInstance, inject, computed, unref, ref, hasInjectionContext, defineComponent, h, Suspense, Fragment, createApp, provide, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, useSSRContext } from 'vue';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BBlYKFLK.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CkUgaJi4.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-7OykL53t.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, asyncDataDefaults as d, entry$1 as default, createError as e, fetchDefaults as f, isStringNumber as g, debugWarn as h, isNumber as i, isUndefined as j, useZIndex as k, defaultInitialZIndex as l, isElement as m, navigateTo as n, isBoolean as o, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u, zIndexContextKey as z };
